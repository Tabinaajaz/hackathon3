    ...
    <div className="w-full h-auto bg-white py-8">
      <div className="grid grid-cols-1 md:grid-cols-2 w-full md:w-[870px] mx-auto py-12">
        ...
        <div className="w-full text-center px-4 md:px-12 md:mx-32">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-montserrat font-bold text-gray-950 tracking-tight mt-4">
            Simple Pricing
          </h2>
          {/* Breadcrumb */}
          <div className="flex justify-center gap-2 mt-4">
            ...
            <a href="/pricing" className="text-xs sm:text-sm md:text-base font-montserrat font-bold text-gray-600">
              Pricing
            </a>
          </div>
        </div>
